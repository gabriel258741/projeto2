...
ping $PN > /tmp/pingar.log | dialog --title "Pingando $PN" --tailbox /tmp/pingar.log 100 100
# Da um aviso, caso a pessoa deseja encerrar o ping, para pressionar CTRL + X
# Dará um tempo de 2 segundos, e começará o ping
case $? in
	0) menu;;
